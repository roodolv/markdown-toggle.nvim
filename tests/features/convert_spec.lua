...
local T = new_set({
  hooks = {
    pre_case = function()
      -- Set up config for convert (list_marks, box_states, default_list_mark)
...
T["set_config()"]["sets configuration for convert"] = function()
  convert.set_config("*+", "x", "*")
  -- Test that config is applied by converting a list
  local result = convert.list_to_box("* content")
  eq(result, "* [ ] content")
end
...
T["box_to_list()"]["converts checkbox to list"] = function()
  eq(convert.box_to_list("- [ ] content"), "- content")
  eq(convert.box_to_list("- [x] content"), "- content")
  eq(convert.box_to_list("* [~] content"), "- content")
  eq(convert.box_to_list("+ [>] content"), "- content")
end
...
T["box_to_olist()"]["converts checkbox to ordered list"] = function()
  eq(convert.box_to_olist("- [ ] content"), "1. content")
  eq(convert.box_to_olist("- [x] content"), "1. content")
  eq(convert.box_to_olist("* [~] content"), "1. content")
  eq(convert.box_to_olist("+ [>] content"), "1. content")
end
...
T["obox_to_olist()"]["converts ordered checkbox to ordered list"] = function()
  eq(convert.obox_to_olist("1. [ ] content"), "1. content")
  eq(convert.obox_to_olist("2. [x] content"), "2. content")
  eq(convert.obox_to_olist("10. [~] content"), "10. content")
  eq(convert.obox_to_olist("99. [>] content"), "99. content")
end
...
T["list_to_olist()"]["converts list to ordered list"] = function()
  eq(convert.list_to_olist("- content"), "1. content")
  eq(convert.list_to_olist("* content"), "1. content")
  eq(convert.list_to_olist("+ content"), "1. content")
end
...
T["list_to_box()"]["converts list to checkbox"] = function()
  eq(convert.list_to_box("- content"), "- [ ] content")
  eq(convert.list_to_box("* content"), "- [ ] content")
  eq(convert.list_to_box("+ content"), "- [ ] content")
end
...
T["olist_to_list()"]["converts ordered list to list"] = function()
  eq(convert.olist_to_list("1. content"), "- content")
  eq(convert.olist_to_list("2. content"), "- content")
  eq(convert.olist_to_list("10. content"), "- content")
  eq(convert.olist_to_list("99. content"), "- content")
end
...
T["olist_to_box()"]["converts ordered list to checkbox"] = function()
  eq(convert.olist_to_box("1. content"), "- [ ] content")
  eq(convert.olist_to_box("2. content"), "- [ ] content")
  eq(convert.olist_to_box("10. content"), "- [ ] content")
  eq(convert.olist_to_box("99. content"), "- [ ] content")
end
...
T["olist_to_obox()"]["converts ordered list to ordered checkbox"] = function()
  eq(convert.olist_to_obox("1. content"), "1. [ ] content")
  eq(convert.olist_to_obox("2. content"), "2. [ ] content")
  eq(convert.olist_to_obox("10. content"), "10. [ ] content")
  eq(convert.olist_to_obox("99. content"), "99. [ ] content")
end
